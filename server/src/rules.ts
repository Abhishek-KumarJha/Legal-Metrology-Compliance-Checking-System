...
export const rules: Rule[] = [
  ...
  { id: 'netQuantity', fieldName: 'netQuantity', label: 'Net quantity', pattern: /(?:NET(?:\s+[A-Z0-9]{2,12}){0,2}|CONTENTS?)\s*[:.-]?\s*([0-9]+(?:\.[0-9]+)?)\s*(kg|g|gm|mg|l|litre|ml)/i, regexPattern: 'quantity + g|kg|ml|l', ruleSection: 'Rule 6(1)(d)', minFontSizeMm: 2, description: 'Standard units and numerals' },
